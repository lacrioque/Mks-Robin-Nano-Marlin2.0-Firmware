...
#define STRING_CONFIG_H_AUTHOR "Markus Fluer" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "OctoVico V4"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 67.10
  #define DEFAULT_bedKi 13.08
  #define DEFAULT_bedKd 229.47
 ...
 * Override with M92
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 * M92 X80.50 Y100.49 Z412.14 E360.00
 */

#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.50, 100.49, 412.14, 360.00}
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS+1), 10, 20 }
